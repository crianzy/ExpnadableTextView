...
public class ExpandTextView extends TextView implements View.OnClickListener {
    ...
    public static final int DEFAULT_BOTTOM_DRAWABLE_PADDING = 10;
    ...
    private boolean mHaveGetLineCount = false;
    private boolean mIsNeedExpand = true;
    ...
    private void init(AttributeSet attrs) {
        ...
        mExpandDrawablePadding = typedArray.getDimensionPixelOffset(R.styleable.ExpandableTextView_bottomDrawablePadding, DEFAULT_BOTTOM_DRAWABLE_PADDING);
    ...
    public void collapseTxt() {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                // 如果在收起动画结束时,设置 maxLines 会导致 收起时 的最后一行 文字 有轻微的变化
...
//                setMaxLines(mMaxCollapsedLines);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.w(TAG, "onMeasure mLineCount = " + mLineCount
